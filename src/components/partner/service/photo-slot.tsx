...
export function pickPhotoPaths(photos: ServicePhotoRow[], stage: string, angles: readonly string[]): string[] {
  return angles
...
export function workflowEventName(
  ...
  phase: "camera_attempt" | "camera_result" | "photo_upload_result",
) {
...
export function useServicePhotoSignedUrl(path?: string | null) {
...
export function PhotoSlot({
  ...
  disabled?: boolean;
  variant?: "default" | "guided-active" | "guided-done" | "guided-locked" | "hero";
  stepNumber?: number;
