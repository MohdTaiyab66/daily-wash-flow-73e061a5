  ...
  return (
    <Card className="mt-3 border-primary/40 bg-gradient-to-br from-primary/10 to-card p-4">
      ...
      <ul className="mt-3 space-y-1.5 text-sm">
        <li className="flex items-center gap-2"><Car className="h-4 w-4 text-muted-foreground" /> <span className="font-medium">{vehicleLabel}</span></li>
        <li className="flex items-center gap-2"><MapPin className="h-4 w-4 text-muted-foreground" /> {areaLabel}</li>
        <li className="flex items-center gap-2"><Clock className="h-4 w-4 text-muted-foreground" /> {deadlineLabel}</li>
        <li className="flex items-center gap-2"><Route className="h-4 w-4 text-muted-foreground" /> {distLabel} from your current route</li>
        <li className="flex items-center gap-2"><IndianRupee className="h-4 w-4 text-success" /> <span className="font-medium text-success">+₹{perDay}/day</span> · +₹{perMonth}/month</li>
        <li className="flex items-center gap-2"><Timer className="h-4 w-4 text-muted-foreground" /> Adds approx. {routeMin} min to route</li>
      </ul>
