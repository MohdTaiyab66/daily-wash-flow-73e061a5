    ...
    >
      {imageUrl ? (
        ...
        <svg
          ...
          aria-label={alt}
          role="img"
          className="h-[82%] w-[88%] drop-shadow-sm"
        >
          <path
            d="M18 39.5c1.8-8 7.3-17.6 14.5-20.3 6.8-2.5 25.6-2.8 33.1-.2 5.1 1.8 10.6 9.4 12.9 17.5l4.7 1.6c2.8.9 4.8 3.5 4.8 6.5v4.1H8v-4.3c0-2.9 1.8-5.5 4.6-6.4l5.4-1.7Z"
            fill="var(--vehicle-paint)"
            stroke="currentColor"
            strokeOpacity="0.14"
            strokeWidth="2"
          />
          <path
            d="M34.5 23.5h12.8v12.2H25.4c2.1-5.3 5.1-10.2 9.1-12.2Zm16.3 0h11.1c4.3 1.3 8.3 6.8 10.7 12.2H50.8V23.5Z"
            fill="var(--card)"
            opacity="0.82"
          />
