...
export function NoSubscriptionState({ vehicleId, vehicleLabel, }) {
    ...
    return (<div className="mt-5 flex flex-col items-center rounded-[18px] border border-[#EEEEEE] bg-white p-8 text-center shadow-sm">
      ...
      <Button className="mt-7 h-11 w-full rounded-xl bg-[#181818] text-white text-[15px] font-semibold active:scale-[0.98] transition-transform" onClick={() => navigate({
            to: "/c/service/$slug",
