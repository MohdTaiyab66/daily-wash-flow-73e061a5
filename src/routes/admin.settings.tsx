...
const SECTIONS: { id: string; title: string; description: string; fields: Field[] }[] = [
  {
    ...
    fields: [
      ...
      { key: "avg_bike_mileage_kmpl", label: "Average bike mileage (km/L)" },
      { key: "fuel_price_per_litre", label: "Fuel price per litre (INR)" },
      { key: "fuel_calc_enabled", label: "Show fuel & net earnings to partners", kind: "bool" },
