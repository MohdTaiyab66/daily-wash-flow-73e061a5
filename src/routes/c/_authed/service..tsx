...
import { 
  ArrowLeft, Car, MapPin, Calendar, Sparkles, Loader2, ChevronRight, 
  Minus, Plus, Clock, RefreshCw, X
} from "lucide-react";
...
function ServiceBookingPage() {
  ...
  const [vehicleId, setVehicleId] = useState<string | null>(localStorage.getItem("uw_customer_vehicle") || null);
