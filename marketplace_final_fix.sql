-- Fixing stale references to 'partner_profiles' which was renamed or replaced by 'partners'
-- This script ensures all marketplace functions use the correct 'partners' table.

-- 1. Redefine mp_reconcile_all_partners_for_broadcast (was using partner_profiles)
...
-- 2. Ensure mp_eligible_partners uses 'partners'
...
-- 3. Redefine get_partner_open_offers to use 'partners'
...
-- 4. Fix any other stale functions in recent migrations
-- Search in 20260814215531_744af557-f2be-4a1f-9f1a-3425cc2e2ca1.sql (it had partner_profiles)
-- Re-running it correctly here.
