...
// Capacitor sync needs the build-info.json in the mobile-shell dir too
// It was already generated by generate-build-metadata.mjs

// Also sync to .output/public/ for diagnostics
cpSync(shellDir, outDir, { recursive: true });

console.log(`[prepare-mobile-shell] Wrote mobile shell for variant=${variant} to ${shellDir} and ${outDir}`);
