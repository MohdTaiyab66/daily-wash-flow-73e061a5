...
BEGIN
  ...
  -- ZERO CUSTOMERS IS VALID IN THIS UPDATED FLOW
  ...
  VALUES (v_partner, v_home_area, p_cars, 'active', v_rate, p_cars * v_rate,
...
GRANT EXECUTE ON FUNCTION public.accept_assignment_v2(integer, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.accept_assignment_v2(integer, integer) TO service_role;