DROP FUNCTION IF EXISTS public.mp_eligible_partners(uuid);
DROP FUNCTION IF EXISTS public.get_partner_open_offers(uuid);
DROP FUNCTION IF EXISTS public.mp_reconcile_all_partners_for_broadcast(uuid);

-- 1. Ensure mp_eligible_partners is robust and simple
-- Replaces partner_profiles with partners and user_id with id
