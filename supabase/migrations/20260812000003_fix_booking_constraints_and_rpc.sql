-- URGENT: FIX BOOKING CONSTRAINTS AND RPC
-- This migration expands the CHECK constraints and fixes the confirm_customer_booking RPC.
...
BEGIN
  ...
  -- Entitlement consumption (₹0 booking)
