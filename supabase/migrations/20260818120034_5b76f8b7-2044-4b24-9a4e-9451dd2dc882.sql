...
BEGIN
  ...
  -- Unified requirement: 1 photo for standard unavailability, 4 for dirty vehicle.
  v_min_photos := CASE WHEN v_is_dirty THEN 4 ELSE 1 END;
  ...
  IF v_customer_user IS NOT NULL AND v_wallet_inserted THEN
