-- Fix ambiguous column reference "broadcast_id" in ON CONFLICT
-- Qualifying the column names in the conflict target to avoid ambiguity when the SELECT clause has the same names.
