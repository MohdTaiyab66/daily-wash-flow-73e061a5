...
AS $function$
 BEGIN
   ...
   SELECT
     ...
     b.booking_id,
     now() as server_now,
     (CASE WHEN b.assignment_id IS NOT NULL THEN 26 ELSE 1 END)::integer as customer_count,
...
GRANT EXECUTE ON FUNCTION public.get_partner_open_offers(uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_partner_open_offers(uuid) TO service_role;